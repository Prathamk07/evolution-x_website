...
export default function index() {
  return (
    <div className="mx-16 flex flex-col items-center justify-center gap-20">
      <div className="inline-flex flex-col items-center justify-center">
        <p className="text-6xl font-bold">
          EvolutionX <span className="text-[#afbdf3]">Blog</span>
        </p>
      </div>
      <div className="flex w-full flex-col gap-10 rounded-3xl bg-black px-14 py-8 pb-16">
        ...
        {/* Blog component */}
        <div className="posts mx-20 grid gap-16 md:grid-cols-2">
          {Array(10)
            .fill({ blogId: "blog1" })
            .map((blognum, index) => (
              <Link to={`/blog/${blognum.blogId}`} key={index}>
                ...
                >
                  ...
                  />
                  <div className="z-50 inline-flex flex-grow flex-col justify-between">
