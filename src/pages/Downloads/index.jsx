...
const Downloads = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-20 md:gap-40">
      ...
      <div className="mx-5 grid gap-10 md:grid-cols-3 md:gap-20">
        {deviceList &&
          !loading &&
          deviceList
            ...
            .map((device, index) => (
              <div key={index}>
                <div className="relative flex h-[28rem] w-[24rem] flex-col justify-between rounded-2xl border border-slate-800 bg-black pb-7 duration-100 ease-in hover:scale-105 hover:shadow-xl">
